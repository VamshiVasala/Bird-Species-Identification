...
#### Data Collection:
The bird sound dataset utilized in this project was sourced by scraping audio recordings from Xeno-Canto, a globally recognized community-driven database of bird sounds. This repository hosts thousands of field recordings contributed by ornithologists and bird enthusiasts.

A total of 2161 audio files (in MP3 format) were collected, representing vocalizations from 114 distinct bird species. These recordings were carefully filtered and organized to ensure quality and relevance for the classification task.

Each audio file is annotated with the corresponding bird species, forming the foundation for supervised learning in deep learning-based audio classification models.

📙 Dataset Source: https://www.xeno-canto.org
